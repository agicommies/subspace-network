...
//         let stake_validator_self_vote = SubspaceModule::get_stake(netuid_yuma,
// &validator_self_key);         let stake_miner_self_vote = SubspaceModule::get_stake(netuid_yuma,
// &miner_self_key);
...
//             + stake_yuma_miner
//             + stake_yuma_miner_self;
//         let end_day_stake = general_netuid_stake + yuma_netuid_stake +
// below_threshold_netuid_stake;         let actual_stake_change = round_first_five(end_day_stake -
// start_stake);
...
// // Test ensures that newly registered subnets will take the "spots" of these deregistered
// subnets. // And modules go beyond the global maximum.
// #[test]
