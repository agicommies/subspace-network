...
//         assert_noop!(SubspaceModule::do_register(get_origin(U256::from(0)), network, name,
// address, 0, U256::from(0), None), Error::<Test>::NotEnoughBalanceToRegister);
...
//             info!("registered module with key: {key:?} and min_stake_to_register:
// {min_stake_to_register:?}");         }
