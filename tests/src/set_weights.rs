...
// SubspaceModule::get_total_stake_to(&U256::from(PASSIVE_VOTER));         let active_stake_before =
// SubspaceModule::get_total_stake_to(&U256::from(ACTIVE_VOTER));
...
//         assert!(
//             passive_stake_before < passive_stake_after || active_stake_before <
// active_stake_after,             "Stake should be increasing"
//         );
...
// SubspaceModule::get_total_stake_to(&U256::from(PASSIVE_VOTER));         let active_stake_after_v2
// = SubspaceModule::get_total_stake_to(&U256::from(ACTIVE_VOTER));
